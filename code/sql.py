...
def create_new_user_account(email, salt, master_key, master_password_hash):
    with sqlite3.connect('data.db') as db:
        db.execute('INSERT INTO Person (email, salt, master_key, master_password_hash, account_creation_timestamp, folder_list) VALUES (?,?,?,?,?,?)',
...
def create_new_login(account_id, login_name, url, username, password, folder):
    with sqlite3.connect('data.db') as db:
        db.execute('INSERT INTO Logins (account_id, login_name, url, username, password, folder, creation_timestamp) VALUES (?,?,?,?,?,?,?)',
...
def create_new_history(account_id, password):
    with sqlite3.connect('data.db') as db:
        db.execute('INSERT INTO History (account_id, password, creation_timestamp) VALUES (?,?,?)', (account_id, password, get_timestamp()))
